  ...
  return (
    <MonacoProvider classList={result.classList || new Set()}>
      ...
      >
        ...
        <div
          className="relative z-10 cursor-col-resize bg-gray-200 outline outline-0 outline-blue-600 transition-all hover:outline-4"
          style={{
            width: lineWidth,
          }}
          onMouseDown={e => {
      ...
      <div
        className="relative z-20 cursor-row-resize bg-gray-200 outline outline-0 outline-blue-600 transition-all hover:outline-4"
        style={{
          height: lineWidth,
        }}
        onMouseDown={e => {
